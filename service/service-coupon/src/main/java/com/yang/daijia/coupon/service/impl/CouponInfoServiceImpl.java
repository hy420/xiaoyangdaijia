package com.yang.daijia.coupon.service.impl;
...
import com.yang.daijia.coupon.mapper.CouponInfoMapper;
import com.yang.daijia.coupon.mapper.CustomerCouponMapper;
import com.yang.daijia.coupon.service.CouponInfoService;
import com.yang.daijia.model.entity.coupon.CouponInfo;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.yang.daijia.model.entity.coupon.CustomerCoupon;
...
public class CouponInfoServiceImpl extends ServiceImpl<CouponInfoMapper, CouponInfo> implements CouponInfoService {
    ...
    public List<AvailableCouponVo> findAvailableCoupon(Long customerId, BigDecimal orderAmount) {
        ...
        //2.1.现金券
        List<NoUseCouponVo> type1List = list.stream().filter(item -> item.getCouponType() == 1).collect(Collectors.toList());
        ...
        //2.2.折扣券
        List<NoUseCouponVo> type2List = list.stream().filter(item -> item.getCouponType() == 2).collect(Collectors.toList());
        ...
        if (!CollectionUtils.isEmpty(availableCouponVoList)) {
            availableCouponVoList.sort((o1, o2) -> o1.getReduceAmount().compareTo(o2.getReduceAmount()));
        }
